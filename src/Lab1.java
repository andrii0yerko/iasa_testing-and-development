...
public class Lab1 {
    ...
    /**
     * Task №1 a function that filters input list integers
     * 
    ...
    /**
     * Task №2 returns the first non-repeating character (case-insensitive for
    ...
    /**
     * Task №3 counts the digital root - recursive sum of all the digits in a number
     * 
     * @param number
    ...
    /**
     * Extra task №1 Takes a positive integer and returns the next bigger number
     * that can be formed by rearranging its digits. If the digits can't be
     * rearranged to form a bigger number, return -1
     * 
     * @param number
    ...
    /**
     * Extra task №2 Takes an unsigned 32 bit number and returns a string
